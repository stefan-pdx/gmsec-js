...
public:
	 ...
	 * by this class, or friends. (to be used by BaseConfigFile class)
	 */
	Status FromXML(xmlNode *msg_element);


	static BaseConfig *getInternal(Config *cfg);

	// These are allowed to access the private FromXML(xmlNode) function
	// friend class BaseConfigFile;
