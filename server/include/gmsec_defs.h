 ...
 *  @sa GMSEC_TYPE
 */
#define GMSEC_TYPE_STRING		9

/** @def GMSEC_TYPE_BIN
 *  @brief field type identifier for GMSEC_BIN field
 *  @sa GMSEC_TYPE
 */
#define GMSEC_TYPE_BIN			10
 ...
 *		GMSEC_MSG_REPLY
 */
typedef unsigned short GMSEC_MSG_KIND;
 ...
 */
enum LogLevel {logNONE, logERROR, logWARNING, logINFO, logVERBOSE, logDEBUG, logNLEVEL};
 ...
 *  Example callback registration:
 *  @code
 * RegisterErrorCallback (conn, "CONNECTION_REQUEST_TIMEOUT", RequestOnError, result, const char* );
 * if( isStatusError(result) )
 *	//handle error
 *  @endcode
 *
