...
/** \fn char * I64toString(GMSEC_I64 val, char *buf)
...
* \param buf The buffer which will hold the converted string.
* \return The converted string.
*/
GMSEC_API char * CALL_TYPE I64toString(GMSEC_I64 val, char *buf);
